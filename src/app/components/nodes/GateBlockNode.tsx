...
export const GateBlockNode: React.FC<{ data: GateBlockNodeData }> = ({ data }) => {
  return (
    <article className="bg-gray-800 text-white border border-gray-900 rounded-lg p-4 min-w-[200px] shadow-md" role="img" aria-label={`${data.label} node with ${data.operator} operator`}>
